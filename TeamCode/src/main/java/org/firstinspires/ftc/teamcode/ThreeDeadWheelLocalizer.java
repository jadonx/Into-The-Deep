...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1911.2880526433567; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2131.5345100721433; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3259.252277731282; // x position of the perpendicular encoder (in tick units)
    }
