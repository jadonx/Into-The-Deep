...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 2032.7088995187569; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -2003.4839444631193; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3270.350620283022; // x position of the perpendicular encoder (in tick units)
    }
